...
namespace ZavrsniLuksic.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            ViewData["Message"] = "Destinacija broj jedan za sve one koji se vole junačiti svojim jezikom, nepcem i probavnim sustavom! Otkrij zapaprenu ponudu najrazvikanijih restorana u regionu!";
            return View();
        }
